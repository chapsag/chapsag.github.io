...
const Paths = {
  ...
  JS: {
    ...
    PLUGINS: [
      ...
      'js/plugins/TweenMax.js',
      'js/plugins/ScrollToPlugin.js',
      'js/plugins/CustomEase.js',
      'js/plugins/DrawSVGPlugin.js',
      'js/plugins/fontawesome-all.js',
    ],
  },
  SCSS: {
    ALL: 'scss/**/*.scss',
  ...
  DEPENDENCIES: {
    ...
    'semantic-ui-accordion': {
      FROM: [
        'node_modules/semantic-ui-accordion/accordion.min.css',
        'node_modules/semantic-ui-accordion/accordion.min.js',
      ],
      TO: lib,
    },
    'semantic-ui-transition': {
      FROM: [
        'node_modules/semantic-ui-transition/transition.min.css',
...
gulp.task('js:sparrow', () =>
  gulp
    .src(Paths.JS.SPARROW)
